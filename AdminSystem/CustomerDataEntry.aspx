...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Label ID="lblAddress" runat="server" style="z-index: 1; left: 11px; top: 227px; position: absolute" Text="Address" width="105px"></asp:Label>
        ...
        <asp:Label ID="lblCreatePassword" runat="server" style="z-index: 1; left: 9px; top: 193px; position: absolute" Text="Create Password"></asp:Label>
        <asp:TextBox ID="txtPassword" runat="server" style="z-index: 1; left: 124px; top: 226px; position: absolute; height: 56px;"></asp:TextBox>
        <asp:Label ID="chkActive" runat="server" style="z-index: 1; left: 70px; top: 302px; position: absolute" Text="Active"></asp:Label>
        <asp:CheckBox ID="CheckBox1" runat="server" OnCheckedChanged="CheckBox1_CheckedChanged" style="z-index: 1; left: 124px; top: 299px; position: absolute" />
        <asp:Label ID="lblErrorId" runat="server" style="z-index: 1; left: 12px; top: 329px; position: absolute"></asp:Label>
        <asp:Button ID="btnOk" runat="server" OnClick="btnOk_Click" style="z-index: 1; left: 13px; top: 353px; position: absolute" Text="OK" />
        <asp:Button ID="btnCancel" runat="server" style="z-index: 1; left: 63px; top: 354px; position: absolute" Text="Cancel" />
    </form>
</body></html>
